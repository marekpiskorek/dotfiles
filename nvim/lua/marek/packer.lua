...
return require('packer').startup(function()
	...
	use 'rcarriga/nvim-notify' -- isn't used at the moment.
  ...
  use {"ojroques/vim-oscyank", config = function() require('vim-oscyank').setup {} end} -- yank onto clipboard through SSH
