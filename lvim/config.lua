...
lvim.transparent_window = false -- disable for now to improve the UX
...
lvim.builtin.bufferline.active = false -- disable bufferline - clearly not for me.
lvim.builtin.gitsigns.opts.current_line_blame = true -- show inline git blame

-- keymappings [view all the defaults by pressing <leader>Lk]
lvim.leader = "space"
-- clear search results with <CR>
...
-- telescope keymap
lvim.keys.normal_mode["<leader>rg"] = ":lua require('telescope.builtin').live_grep{}<CR>"
