...
plugins=(git fzf vi-mode zsh-fzf-history-search zsh-syntax-highlighting)
...
export DB_URI_HOST=localhost
export DB_URI_PORT=5432
export DB_URI_USER="marek.piskorek"
export DB_URI_PASSWORD=qwe123

export TEST_DB_NAME=codility_test
export DBNAME=codility
